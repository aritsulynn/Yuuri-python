...
def write_test(dataAnimeAll):
    ...
    try:
        with (open('src/temp/data.txt', 'w', encoding="utf-8") as data,
         open('src/temp/name_checking.txt', 'r+', encoding="utf-8") as name_checking):
        ...
        # One-time
        with open('src/temp/data.txt', 'w', encoding="utf-8") as data, open('src/temp/name_checking.txt', 'w', encoding="utf-8") as name_checking:
...
def check_update_or_not():
    try:
        with open("src/temp/name_checking.txt", "r", encoding="utf-8") as f:
...
def send_update():
    all_names = []
    with open("src/temp/data.txt", "r", encoding="utf-8") as f:
